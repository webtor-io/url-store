...
var file_url_store_proto_rawDesc = []byte{
	...
	,
...
var file_url_store_proto_goTypes = []interface{}{
	...
	(*CheckReply)(nil),   // 3: CheckReply
}
var file_url_store_proto_depIdxs = []int32{
	1, // 0: UrlStore.Push:input_type -> PushRequest
	2, // 1: UrlStore.Check:input_type -> CheckRequest
	0, // 2: UrlStore.Push:output_type -> PushReply
	3, // 3: UrlStore.Check:output_type -> CheckReply
...
func (c *urlStoreClient) Push(ctx context.Context, in *PushRequest, opts ...grpc.CallOption) (*PushReply, error) {
	out := new(PushReply)
	err := c.cc.Invoke(ctx, "/UrlStore/Push", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *urlStoreClient) Check(ctx context.Context, in *CheckRequest, opts ...grpc.CallOption) (*CheckReply, error) {
	out := new(CheckReply)
	err := c.cc.Invoke(ctx, "/UrlStore/Check", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedUrlStoreServer can be embedded to have forward compatible implementations.
...
func RegisterUrlStoreServer(s *grpc.Server, srv UrlStoreServer) {
	s.RegisterService(&_UrlStore_serviceDesc, srv)
}
...
var _UrlStore_serviceDesc = grpc.ServiceDesc{
	ServiceName: "UrlStore",
